<div><div id="usuariosDatasul">Usuários de Rede: <span id="valorUsuariosDatasul"><?=$totalDatasul;?></span></div>
...
function checkUnidade() {
	...
	$.post("../dinamicos/portfolio-rede.php?"+resultado, {usu: "70"}, function(resposta) {
...
function checkcc() {
	...
	$.post("../dinamicos/centros-custo-rede.php?"+resultado, {usu: "70"}, function(resposta) {
       // Coloca a resposta na DIV
       $("#resultadosCheck").html(resposta);
